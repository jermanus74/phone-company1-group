      ...
      <div className="container mt-10">
        ...
        <section className="py-16">
          <div className="container mx-auto text-center">
            ...
            />
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              At our core, we believe in harnessing technology to create
              solutions that inspire and connect people globally. Our vision is
              to be a leader in sustainable innovation, ensuring a brighter
